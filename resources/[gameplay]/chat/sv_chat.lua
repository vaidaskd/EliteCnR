...
-- player join / leave messages — DISABLED for CnR.
-- The cnr resource posts its own role-coloured join/leave lines in the game feed
-- (cop blue / wanted red / prisoner orange / innocent white). The default green chat
-- lines here were a duplicate, so they are turned off unconditionally. #1
--[[
